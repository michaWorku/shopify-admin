                                        ...
                                        <AccordionDetails>
                                            <FormControlLabel
                                                control={
                                                    ...
                                                    >
                                                        <Checkbox
                                                            checked={systemPermission.every(
                                                                (item: any) => {
                                        ...
                                        <AccordionDetails>
                                            <FormControlLabel
                                                control={
                                                    ...
                                                    >
                                                        <Checkbox
                                                            checked={entityPermissions.every(
                                                                (item: any) => {
                                                                    return permissionIds.includes(
                                                                        item.id
                                                                    )
