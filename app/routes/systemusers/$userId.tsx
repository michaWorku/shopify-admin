              ...
              <Form onSubmit={handleSubmit}>
                ...
                >
                  ...
                  >
                    <Box sx={{ px: 5, pt: 5 }}>
                      ...
                      <Typography>Edit user data by changing fields</Typography>
                    </Box>
                ...
                >
                  ...
                  <TextField
                    ...
                    sx={{ py: 1 }}
                    variant="filled"
                    defaultValue={loaderData?.data?.middleName}
                    onChange={handleChange}
                    fullWidth
                    helperText={
                      actionData?.error?.fieldError &&
                  ...
                  <DesktopDatePicker
                    ...
                    renderInput={(params) => (
                      <TextField
                        ...
                        fullWidth
                        variant="filled"
                        defaultValue={loaderData?.data?.birthDate}
                        helperText={
                          actionData?.error?.fieldError &&
                  ...
                  <Box display="flex" alignItems="center" gap={1}>
                    ...
                    <RadioGroup
                      ...
                      name="gender"
                      defaultValue={loaderData?.data?.gender}
                      onChange={handleChange}
                    >
                      <FormControlLabel
                        value={GenderValue[1]}
                  ...
                  <Autocomplete
                    ...
                    options={loaderData?.data?.userRoles || []}
