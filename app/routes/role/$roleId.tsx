      ...
      if (systemUserAbility.status === 200) {
        ...
        return json(
          Response({
            data: {
              role: role,
              systemPermissions: systemPermissions?.rolePermissions?.some(
                (e: any) => e.selected
              )
                ? systemPermissions?.rolePermissions
                : null,
              clientPermissions: clientPermissions?.rolePermissions?.some(
                (e: any) => e.selected
              )
                ...
                >
                  <Box sx={{ px: 5, pt: 5 }}>
                    <Typography variant="h6">
                      {view ? "View Role Permissions" : "Update Role"}
                    </Typography>
                  </Box>
                      ...
                      <Grid container>
                        <Grid xs={12} sm={8}>
                          <TextField
                            ...
                            helperText={
                              actionData?.error &&
                              actionData?.fieldError?.fieldErrors?.name
                            ...
                            error={
                              actionData?.error &&
                              actionData?.error?.error?.fieldError &&
                            ...
                            {clientPermissions && clientPermissions?.length ? (
                              <Accordion>
                                <AccordionSummary
                                  ...
                                  id="panel1a-header"
                                >
                                  <Typography>Client Permissions</Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                  <PermissionList
                                    handlePermissionChange={
                      ...
                      {view ? (
                        ...
                        >
                          ...
                          transitionData.name ? (
                            ...
                            <Typography color="white">Save role</Typography>
                          )}
                        </Button>
                      )}
                    </Box>
